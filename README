This CV assumes you have the [res.cls](http://ctan.org/pkg/res) file in either your texmf directory structure or, more simply, in the same directory as the tex file. To compile, simply run:
