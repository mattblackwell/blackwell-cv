...
\item[] Awarded the 2011 John T. Williams prize by the Society for Political Methodolgy for best dissertation proposal.
\end{list1}
...
Missing Data,''} (with James Honaker and Gary King) \emph{Under Review}.\vspace{1em}\\
%\begin{list1}
...
{\bf ``A Framework for Dynamic Causal Inference in Political Science,''} \emph{Under Review}.\vspace{1em}\\
%\begin{list1}
...
\begin{list1}
\item[] \emph{Dynamic Causal Inference and Negative Advertising} (Poster presentation)
\end{list1}\vspace{-0em}
