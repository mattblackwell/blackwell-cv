...
%\end{list1} \vspace{-.5em}
Matthew Blackwell, \href{http://gking.harvard.edu/files/gamechangers.pdf}{``Game-changers: Detecting shifts in the flow
  of campaign contributions,''} \emph{Under Review}. 

Matthew Blackwell and Justin Grimmer, {\bf ``Congressional Staff Networks.''}

Matthew Blackwell and Adam Glynn, {\bf ``How to Make Causal Inferences with Time-Series
