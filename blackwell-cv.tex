...
\name{\fontsize{36}{36}  \fontspec{League Gothic} \textcolor{IndianRed}{MATTHEW BLACKWELL}}
\begin{resume}
...
Matthew Blackwell and Michael Olson, \href{https://mattblackwell.org/files/papers/lasso-inters.pdf}{``Reducing Model Misspecification and Bias in the Estimation of Interactions.''} \emph{Political Analysis}, Conditionally Accepted. 
...
Matthew Blackwell and Nicole Pashley, \href{https://mattblackwell.org/files/papers/factorial-iv.pdf}{``Noncompliance and instrumental variables for $2^K$ factorial experiments.''} Invited to Revise and Resubmit. 
...
Matthew Blackwell and Soichiro Yamauchi. ``Adjusting for Unmeasured Confounding in Marginal Structural Models with Propensity-Score Fixed Effects.''
