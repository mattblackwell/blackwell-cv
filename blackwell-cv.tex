...
\def\myemail{mblackwell@gmail.com}
...
\begin{minipage}[t]{2.5in}
  ...
  {\scriptsize  \texttt{\href{https://www.linkedin.com/in/matthew-lee-blackwell/}{linkedin.com/in/matthew-lee-blackwell/}} \, \faLinkedinSquare}
\end{minipage}
...
\begin{cvlist}
\item {\bfseries Staff Data Scientist, Search Platforms, Google}
\begin{cvlist}
  \item January 2025--Present. Experimentation and offline evaluation platforms for AI products. 
\end{cvlist}

\item {\bfseries Harvard University}, {\em Department of Government}
\begin{cvlist}
\item Associate, July 2025--June 2026.
\item Associate Professor (untenured), July 2018--June 2025. 
\item Assistant Professor, July 2014--June 2018. 
\item Affiliate, Institute for Quantitative Social Science.
\end{cvlist}

\item {\bfseries Assistant Professor, University of Rochester}, {\em Department of Political Science}
\begin{cvlist}
\item   July 2012-June, 2014. 
\end{cvlist}
\end{cvlist}
\bigskip
...
\noindent \begin{etaremune}[  itemsep = 1em,
  topsep = 0em,
  partopsep=0in,
  leftmargin=1.5em]

\item Matthew Blackwell and Soichiro Yamauchi. \href{https://mattblackwell.org/files/papers/psfe.pdf}{``The Effect of Political Advertising after \emph{Citizens United}: Adjusting for Unmeasured Confounding in Marginal Structural Models.''} \emph{Forthcoming, Journal of the Royal Statistical Society (Series A)}

  
\item Matthew Blackwell and Nicole E. Pashley. \href{https://arxiv.org/pdf/2407.12114}{``Bounds on causal effects in $2^K$ factorial experiments with non-compliance.''} \emph{Forthcoming, Biometrika}

  
\item Matthew Blackwell, Adam Glynn, Hanno Hilbig, and Connor Halloran Phillips. \href{https://www.mattblackwell.org/files/papers/did_cde.pdf}{``Difference-in-differences Designs for Controlled Direct Effects: An Application to Reducing Intergroup Prejudice.''} \emph{Forthcoming, Journal of the Royal Statistical Society (Series A)}


\item Matthew Blackwell, Jacob Brown, Sophie Hill, Kosuke Imai and Teppei Yamamoto. \href{https://arxiv.org/pdf/2306.01211}{``Priming Bias versus Post-treatment Bias in Experimental Designs.''} \emph{Political Analysis}, Vol. 33, No. 4 (2025): 361--377.
(2017): 590--599. 
\begin{itemize}[topsep=0em]
\item  Winner of the 2026 \emph{Political Analysis} Editor's Choice Award
\end{itemize}
