...
%\end{list1} \vspace{-.5em}
Matthew Blackwell, {\bf ``Game-changers: Detecting shifts in the flow
  of campaign contributions,''} \emph{Under Review}. 

Matthew Blackwell and Justin Grimmer, {\bf ``Congressional Staff Networks.''}

Matthew Blackwell, {\bf ``A Direct Confounding Approach to Sensitivity
Analysis for Causal Effects.''}
