...
2011. {\bf Research Workshop in American Politics}, Department of
Political Science, University of California, Berkeley. December.
\begin{list1}
\item[] ``All politics are dynamic: How time and strategy mask the
  importance of negative advertising.''
\end{list1}
...
\begin{list1}
\item[] Government 2000: Introduction to Quantiative Methods I, {\em Teaching Fellow}.
\item[] Social Analysis 46: Thinking about Politics, A Rational Choice Approach, {\em Teaching Fellow}.
\item[] API-209: Introduction to Quantitative Methods, Harvard Kennedy School,  {\em Teaching Fellow}.
\item[] Government 50: Introduction to Research Design,  {\em Head Teaching Fellow}.
\end{list1}
