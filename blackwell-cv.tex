...
\item Matthew Blackwell and Nicole Pashley, \href{https://mattblackwell.org/files/papers/factorial-iv.pdf}{``Noncompliance and instrumental variables for $2^K$ factorial experiments.''} \emph{Journal of the American Statistical Association}, Forthcoming (2023).
...
\bigskip
\marginhead{Book manuscript}
\noindent \begin{enumerate}[leftmargin=0.2in, topsep = 0in, partopsep=0in, itemsep=1em]

\item Matthew Blackwell. \href{https://mattblackwell.github.io/gov2002-book/}{\emph{A User’s Guide to Statistical Inference and Regression}}, Manuscript
