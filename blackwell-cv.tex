...
Matthew Blackwell and Michael Olson, ``On Model Dependence in the Estimation of Interactive Effects.'' 
...
\item[] Benjamin Laughlin (University of Rochester, Postdoctoral Fellow at University of Pennsylvania).
...
\item[] Michael Olson (Harvard University, In Progress).
\end{list1}
